    ...
    >
      <Container>
        ...
        <div className="mt-5 max-w-3xl space-y-5 mx-auto">
          ...
          <p className="font-semibold">
            <span className="font-bold text-xl">Personalized Matching:</span>{" "}
            Our advanced matchmaking algorithms consider your preferences,
            values, and aspirations to connect you with compatible life
            partners.
          </p>
          <p className="font-semibold">
            <span className="font-bold text-xl">Security and Privacy:</span>{" "}
            Your privacy is our priority. We employ strict security measures to
            ensure your information remains confidential and secure.
          </p>
          <p className="font-semibold">
            <span className="font-bold text-xl">Diverse Profiles:</span> Our
            platform embraces diversity. Explore a rich tapestry of profiles
            from various backgrounds, cultures, and communities.
          </p>
          <p className="font-semibold">
            <span className="font-bold text-xl">Guidance and Support:</span> Our
            dedicated team is here to guide you through your journey. From
            profile creation to the first meeting, we provide support at every
            step.
          </p>
